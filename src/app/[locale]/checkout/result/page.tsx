...
export default function CheckoutResultPage() {
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <Suspense fallback={
                <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full text-center py-12">
                    <Loader2 className="animate-spin text-brand-gold mb-4 mx-auto" size={48} />
                    <h2 className="text-xl font-bold text-gray-800">Cargando resultado...</h2>
                </div>
            }>
                <ResultContent />
            </Suspense>
