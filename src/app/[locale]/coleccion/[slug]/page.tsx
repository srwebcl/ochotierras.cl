...
import { ArrowLeft, Check, Download, Droplet, Thermometer, Grape, MapPin, Calendar, Award } from "lucide-react"
...
export default function CollectionPage() {
    ...
    const localizedSubtitle = product ? (product.subtitle || product.type) : '';
        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="relative bg-brand-dark min-h-[90vh] flex items-center pt-24 pb-20 overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    {/* Product Details - NO PRICE, NO BUY BUTTON */}
                    <motion.div
